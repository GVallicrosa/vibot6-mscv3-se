...
string shortfilename ("octogonal0024");
...
int main(int argc,char ** argv){
 ...
 timer.Start();
    ...
    Init();
    Vector2d ImRes;    LoadJPG ( "Images\\octogonal0024.jpg", 0 , ImRes);
    ...
    filename.append(".jpg_contour1.txt");
    ...
    filename3.append(".jpg_contour1.txt");
...
//    system("pause");
  ...
  //  reshape(ImRes[0],ImRes[1]);
    ...
    string filename4 ("Contours\\Results");
