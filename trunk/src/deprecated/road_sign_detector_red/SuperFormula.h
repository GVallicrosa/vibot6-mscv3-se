...
class RationalSuperShape2D{
	...
	public:
        ...
        */
        ...
        void RobustInit(vector< Vector2d >);
		...
		//display functions
		void DrawCurve(double R = 0, double G = 0, double B = 0, const int width = 1, const int sampling = 50, const bool stippleon = false);
		void SpecialDrawCurve(double R , double G , double B , const int width , const int sampling  );
		void DrawIntensity( const Vector2d UpCorner, const Vector2d BottomCorner, const int sampling=100);
        void SetBuffer(int, double**);

        double MinDist(Vector2d P, int n = 100);

        Vector2d ClosestPoint( Vector2d P, int lvbrg_itmax = 1);

        void Aff();

        void Mutate();
        double DrDtheta(double tht);
        vector < Vector2d > GenerateData (int n= 100, double x0 = 0, double y0 = 0, double tht0 = 0, bool  RandAngularValues = true, double noiserate = 0, string filename = "data.txt" );

        vector < Vector2d > GenerateUniformData (int n= 100, double x0 = 0, double y0 = 0, double tht0 = 0, bool  RandAngularValues = true, double noiserate = 0, string filename = "data.txt" );
...
//        bool ScalarFieldToPPM(const Vector2d UpCorner, const Vector2d BottomCorner, double resolution_x, double resolution_y,std::string filename, bool op, int m);
        ...
        vector < Vector2d> InitRotationAndSymmetry( vector < Vector2d >,  int framesize = 3);
};
...
class RationalSuperShape3D{
    ...
    public:
		...
		RationalSuperShape3D(
                            double a1, double b1, double n11,double n12,double n13,double p1, double q1, double thtoffset1, double phioffset1, double xoffset1, double y_offset1, double zoffset1,
                            double a2, double b2, double n21,double n22,double n23,double p2, double q2, double thtoffset2, double phioffset2, double xoffset2, double y_offset2, double zoffset2);
        void Init(
                            double a1, double b1, double n11,double n12,double n13,double p1, double q1, double thtoffset1, double phioffset1, double xoffset1, double y_offset1, double zoffset1,
                            double a2, double b2, double n21,double n22,double n23,double p2, double q2, double thtoffset2, double phioffset2, double xoffset2, double y_offset2, double zoffset2);

		virtual ~RationalSuperShape3D();

		inline double Get_a1()  {return Parameters1 [0];};
		inline double Get_a2()  {return Parameters2 [0];};

        inline double Get_b1()  {return Parameters1 [1];};
        inline double Get_b2()  {return Parameters2 [1];};

        inline double Get_n11() {return Parameters1 [2];};
        inline double Get_n21() {return Parameters2 [2];};

        inline double Get_n12() {return Parameters1 [3];};
        inline double Get_n22() {return Parameters2 [3];};

        inline double Get_n13() {return Parameters1 [4];};
        inline double Get_n23() {return Parameters2 [4];};

        inline double Get_p1()  {return Parameters1 [5];};
        inline double Get_p2()  {return Parameters2 [5];};

        inline double Get_q1()  {return Parameters1 [6];};
        inline double Get_q2()  {return Parameters2 [6];};

        inline double Get_thtoffset1()  {return Parameters1 [7];};
        inline double Get_thtoffset2()  {return Parameters2 [7];};

        inline double Get_phioffset1()  {return Parameters1 [8];};
        inline double Get_phioffset2()  {return Parameters2 [8];};

        inline double Get_xoffset1()  {return Parameters1 [9];};
        inline double Get_xoffset2()  {return Parameters2 [9];};

        inline double Get_yoffset1()  {return Parameters1 [10];};
        inline double Get_yoffset2()  {return Parameters2 [10];};

        inline double Get_zoffset1()  {return Parameters1 [11];};
        inline double Get_zoffset2()  {return Parameters2 [11];};

        inline double Set_a1 ( const double a)  {Parameters1 [0]=a;};
        inline double Set_a2 ( const double a)  {Parameters2 [0]=a;};

        inline double Set_b1 ( const double b)  {Parameters1 [1]=b;};
        inline double Set_b2 ( const double b)  {Parameters2 [1]=b;};

        inline double Set_n11( const double n1) {Parameters1 [2]=n1;};
        inline double Set_n21( const double n1) {Parameters2 [2]=n1;};

        inline double Set_n12( const double n2) {Parameters1 [3]=n2;};
        inline double Set_n22( const double n2) {Parameters2 [3]=n2;};

        inline double Set_n13( const double n3) {Parameters1 [4]=n3;};
        inline double Set_n23( const double n3) {Parameters2 [4]=n3;};

        inline double Set_p1 ( const double p)  {Parameters1 [5]=p;};
        inline double Set_p2 ( const double p)  {Parameters2 [5]=p;};

        inline double Set_q1 ( const double q)  {Parameters1 [6]=q;};
        inline double Set_q2 ( const double q)  {Parameters2 [6]=q;};

        inline double Set_thtoffset1 ( const double thtoffset)  {Parameters1 [7]=thtoffset;};
        inline double Set_thtoffset2 ( const double thtoffset)  {Parameters2 [7]=thtoffset;};

        inline double Set_phioffset1 ( const double phioffset)  {Parameters1 [8]=phioffset;};
        inline double Set_phioffset2 ( const double phioffset)  {Parameters2 [8]=phioffset;};

        inline double Set_xoffset1 ( const double xoffset)  {Parameters1 [9]=xoffset;};
        inline double Set_xoffset2 ( const double xoffset)  {Parameters2 [9]=xoffset;};

        inline double Set_yoffset1 ( const double yoffset)  {Parameters1 [10]=yoffset;};
        inline double Set_yoffset2 ( const double yoffset)  {Parameters2 [10]=yoffset;};

        inline double Set_zoffset1 ( const double zoffset)  {Parameters1 [11]=zoffset;};
        inline double Set_zoffset2 ( const double zoffset)  {Parameters2 [11]=zoffset;};

        void RandomInit();
        void Simplify();
        void Mutate();
        double GetSurfaceArea() {return 0;};
        double ImplicitFunction( Vector3d);

        Vector2d radius (const double theta, const double phi);

        void DrawSurface(
            bool buildsurface = false,
            bool drawpoints = false,
            bool drawfullfaces = true,
            bool drawwirefaces = true,
        ...
        void BuildSurface(const int sampling = 50);

    };
void IsosurfaceViewer(RationalSuperShape2D RSref, Vector3d StarPoint, Vector3d EndPoint, double tolerance = 1e-3,int n=50 );
...
RationalSuperShape3D ComputeAverage(vector<RationalSuperShape3D>);
RationalSuperShape3D ComputeVariance(vector<RationalSuperShape3D>, RationalSuperShape3D AVG);
